...
public class Sessions {
	...
	public String toString() {
		return "Session [center_id=" + center_id + ", name=" + name + ", state_name=" + state_name + ", district_name="
				+ district_name + ", block_name=" + block_name + ", pincode=" + pincode + ", from=" + from + ", to="
				+ to + ", lat=" + lat + ", fee_type=" + fee_type + ", session_id=" + session_id + ", date=" + date
